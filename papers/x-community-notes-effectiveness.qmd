...
**Only 4% of all submitted Community Notes have never been published; 96% remain hidden from the general public.**
...
**The median Community Note time-to-publish (TTP) is 8.7 hours, but with a large amount of variation (Mean 35.8 and SD 158.7)**
...
-   Post **Likes** have the opposite effect of the other engagement metrics, associated with shorter TPP in the early quartiles, and longer TTP in the later quartiles.
...
-   **Friend Count** and **Follower Count**: Both variables are associated with 5-10% shorter TPP in the first three quartiles, possibly correlated to Posts with larger followings and reach.
